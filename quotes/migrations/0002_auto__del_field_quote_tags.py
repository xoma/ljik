...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('quotes_quote', 'tags_id')
    ...
    def backwards(self, orm):
        ...
        db.add_column('quotes_quote', 'tags', self.gf('django.db.models.fields.related.ForeignKey')(default=3, to=orm['core.Tag']), keep_default=False)
