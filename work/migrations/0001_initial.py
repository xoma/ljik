...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Work'
        db.create_table('work_work', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('author', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('pub_date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2010, 12, 9, 16, 10, 35, 99882), blank=True)),
            ...
            ('is_do', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('work', ['Work'])

        # Adding M2M table for field tags on 'Work'
        db.create_table('work_work_tags', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('work', models.ForeignKey(orm['work.work'], null=False)),
            ('tag', models.ForeignKey(orm['core.tag'], null=False))
        ))
        db.create_unique('work_work_tags', ['work_id', 'tag_id'])


    def backwards(self, orm):
        
        # Deleting model 'Work'
        db.delete_table('work_work')

        # Removing M2M table for field tags on 'Work'
        db.delete_table('work_work_tags')
    ...
    models = {
        ...
        'work.work': {
            ...
            'pub_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 12, 9, 16, 10, 35, 99882)', 'blank': 'True'}),
