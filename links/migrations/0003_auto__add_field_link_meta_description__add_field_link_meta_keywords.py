...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('links_link', 'meta_description', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)

        # Adding field 'Link.meta_keywords'
        db.add_column('links_link', 'meta_keywords', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)

        # Removing M2M table for field tags on 'Link'
        db.delete_table('links_link_tags')


    def backwards(self, orm):
        
        # Deleting field 'Link.meta_description'
        db.delete_column('links_link', 'meta_description')

        # Deleting field 'Link.meta_keywords'
        db.delete_column('links_link', 'meta_keywords')

        # Adding M2M table for field tags on 'Link'
        db.create_table('links_link_tags', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('link', models.ForeignKey(orm['links.link'], null=False)),
            ('tag', models.ForeignKey(orm['core.tag'], null=False))
        ))
        db.create_unique('links_link_tags', ['link_id', 'tag_id'])
    ...
    models = {
        ...
        'links.link': {
            ...
            'pub_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 1, 29, 19, 25, 42, 494782)', 'blank': 'True'}),
